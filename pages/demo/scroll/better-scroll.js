                ...
                "string" == typeof s && (s = this.scroller.querySelectorAll(s)), this.on("refresh", function () {
                    if (t.pages = [], t.wrapperWidth && t.wrapperHeight && t.scrollerWidth && t.scrollerHeight) {
                        var e = i.stepX || t.wrapperWidth,
                            ...
                            m = void 0;
                        if (s)
                            for (c = s.length, d = -1; p < c; p++) m = o(s[p]), (0 === p || m.left <= o(s[p - 1]).left) && (u = 0, d++), t.pages[u] || (t.pages[u] = []), r = Math.max(-m.left, t.maxScrollX), h = Math.max(-m.top, t.maxScrollY), a = r - Math.round(m.width / 2), l = h - Math.round(m.height / 2), t.pages[u][d] = {
                                x: r,
                                y: h,
                                width: m.width,
                                height: m.height,
                            ...
                            for (a = Math.round(e / 2), l = Math.round(n / 2); r > -t.scrollerWidth;) {
                                for (t.pages[p] = [], c = 0, h = 0; h > -t.scrollerHeight;) t.pages[p][c] = {
